...
%WCC4SM_V0_9_2 Wavelength Characterization and Calibration for Spectrometer.
...
% MATLAB R2022a or later. Signal Processing Toolbox is required for findpeaks.
    ...
    fig=uifigure('Name','WCC4SM V0.9.2 | Peak Analysis','Position',[25 30 1580 900],'Color',C.bg);
    ...
    uilabel(hg,'Text','WCC4SM (Wavelength Characterization and Calibration for Spectrometer) V0.9.2', ...
    ...
    function openLocalSearchDialog(~,~)
        ...
        ld=uifigure('Name','WCC4SM V0.9.2 | Weak-peak subwindow search','Position',[180 160 520 520],'Color',C.bg);
    ...
    function openResidualAnalysis(~,~)
        ...
        rf=uifigure('Name','WCC4SM V0.9.2 | Calibration Fit & Residual Analysis','Position',[120 90 1160 760],'Color',C.bg);
    ...
    function popOutSpectrumPlots(~,~)
        pf=figure('Name','WCC4SM V0.9.2 | Current spectrum plots','Color','white','Position',[100 80 1100 760]);
    ...
    function openSelectedTabFigures(~,~)
        ...
        for kk=1:numel(sourceAxes)
            ...
            pf=figure('Name',sprintf('WCC4SM V0.9.2 | %s | %s',tabName,plotTitle), ...
