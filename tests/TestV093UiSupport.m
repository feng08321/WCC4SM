classdef TestV093UiSupport < matlab.unittest.TestCase
    methods (Test)
        function sourceUsesV093EntryPointAndKeepsCompatibilityWrapper(testCase)
            src = fileread(fullfile(fileparts(fileparts(mfilename('fullpath'))),'WCC4SM_V0_9_3.m'));
            wrapper = fileread(fullfile(fileparts(fileparts(mfilename('fullpath'))),'WCC4SM_V0_9_2.m'));
            testCase.verifySubstring(src,'function WCC4SM_V0_9_3');
            testCase.verifySubstring(src,'WCC4SM V0.9.3');
            testCase.verifySubstring(wrapper,'WCC4SM_V0_9_3');
        end
